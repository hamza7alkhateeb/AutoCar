...
class Listing(models.Model):
    ...
    trader = models.ForeignKey(Traders, on_delete=models.DO_NOTHING)
    ...
    color = models.CharField(choices=colorType.choices, default=colorType.ANY, max_length=20)
    fuel_type = models.CharField(
        choices=FuelType.choices, default=FuelType.DIESEL, max_length=50)
    car_type = models.CharField(
        choices=CarType.choices, default=CarType.SEDAN, max_length=50)
