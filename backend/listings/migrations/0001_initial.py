    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(choices=[('Red', 'Red'), ('Blue', 'Blue'), ('Black', 'Black'), ('Brown', 'Brown'), ('Any', 'Any')], default='Any', max_length=20)),
                ('fuel_type', models.CharField(choices=[('Gasoline', 'Gasoline'), ('Petrol', 'Petrol'), ('Diesel', 'Diesel'), ('Ethanol', 'Ethanol')], default='Diesel', max_length=50)),
                ('car_type', models.CharField(choices=[('Sedan', 'Sedan'), ('Coupe', 'Coupe'), ('Suv', 'Suv'), ('Hatchback', 'Hatchback'), ('Sports', 'Sports')], default='Sedan', max_length=50)),
                ...
                ('trader', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='traders.traders')),
            ],
        ),
    ]
